...
# ╔═╡ e4b3a5a8-6a27-11ec-29f9-272f980a8135
#imports

begin
  using Symbolics ,Plots ,ForwardDiff ,PlutoUI ,LaTeXStrings
  using ForwardDiff:jacobian
end

# ╔═╡ e4b3a592-6a27-11ec-2832-73d2f6d62539
html"""
...
# ╔═╡ 12720fce-8e77-4e4a-8cb2-26325c24835b
...
# ╔═╡ ddeb3a34-a3ff-4e7d-ac30-052a6c4c2906
md"""
k = $(@bind k Slider(0:10000, show_value=true, default=6))
"""

# ╔═╡ c82f1011-810f-491e-93be-a75ea186719c
md"""
n = $(@bind n Slider(0:100, show_value=true, default=37))
"""

# ╔═╡ d2e9706a-b016-45e8-9796-5089128ac8e9
newton1D(x -> x^2 - k, n)
